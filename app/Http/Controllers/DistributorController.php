...
class DistributorController extends Controller
{
     public function distributor()
    {
        ...
        $response = Http::withToken("$token")->get('https://keuangan.dlhcode.com/api/distributor');
    ...
    public function tambah_distributor(Request $request)
    {
        ...
        ])->post('https://https://keuangan.dlhcode.com/api/tambah_distributor', $addDistributor);
    ...
    public function delete_distributor($id)
    {
        $token = session('access_token');
        $client = new Client([
        'base_uri' => 'https://keuangan.dlhcode.com/api/api/',
        'timeout' => 2.0,
        ]);
