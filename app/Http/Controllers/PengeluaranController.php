...
class PengeluaranController extends Controller
{
    public function pengeluaran()
    {
        ...
        $response = Http::withToken("$token")->get('https://keuangan.dlhcode.com/api/pengeluaran');
    ...
    public function tambah_pengeluaran(Request $request)
    {
        ...
        ])->post('https://keuangan.dlhcode.com/api/tambah_pengeluaran', $addPengeluaran);
    ...
    public function edit_pengeluaran($id)
    {
        ...
        $token = session('access_token');
        $client = new Client([
        'base_uri' => 'https://keuangan.dlhcode.com/api/',
        'timeout' => 2.0,
        ]);
