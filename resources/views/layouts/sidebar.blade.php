    ...
    <nav class="navbar bg-light navbar-light">
        <a href="#" class="navbar-brand mx-4 mb-3">
            <h6 class="text-primary">
                {{-- <img src="{{ asset('img/logo-pvc.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> --}}
        <span class="brand-text font-weight-light">PT. PANORAMA VARIA CIPTA</span></i></h6>
        </a>
