 ...
 <div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="card mb-5">
                <div class="card-body">
                    <h4 class="card-header">EDIT DATA KARYAWAN</h4>
                    <form action="{{ route('update.karyawan', ['id' => $karyawan['id']]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                             <div class="mb-3">
